...
CREATE OR REPLACE PROCEDURE "SP_DATA_PROFILER5"("RUN_ID" VARCHAR, "DATASET_ID" VARCHAR, "DATASET_NAME" VARCHAR, "DBNAME" VARCHAR, "SCHEMANAME" VARCHAR, "TABLENAME" VARCHAR, "CUSTOMSQL" VARCHAR)
RETURNS VARCHAR
LANGUAGE PYTHON
...
def run_profiler_sp(session, run_id: str, dataset_id: str, dataset_name: str, dbname: str, schemaname: str, tablename: str, customsql: str) -> str:
    ...
    # --- Conditional Metadata Exclusion (Enhancement 2) ---
    if customsql:
